...
namespace Cowboy.Sockets
{
    public class TcpSocketClient : IDisposable
    {
        ...
        {
            return string.Format("RemoteEndPoint[{0}], LocalEndPoint[{1}]", this.RemoteEndPoint, this.LocalEndPoint);
        }
        ...
        private Stream NegotiateStream(Stream stream)
        {
            ...
            var validateRemoteCertificate = new RemoteCertificateValidationCallback(
                ...
                =>
                {
                    ...
                    if (_configuration.SslPolicyErrorsBypassed)
                        ...
                        _log.Error("Error occurred when validating remote certificate: [{0}], [{1}].", this.RemoteEndPoint, sslPolicyErrors);
            ...
            if (!ar.AsyncWaitHandle.WaitOne(ConnectTimeout))
            {
                ...
                throw new TimeoutException(string.Format("Negotiate SSL/TSL with remote [{0}] timeout [{1}].", this.RemoteEndPoint, ConnectTimeout));
            }
        ...
        {
            _log.Error(string.Format("Client [{0}] error occurred in user side [{1}].", this, ex.Message));
        }
