...
namespace C3SockNetUtil
{
    ...
    {         
        public static void Boolean(ref byte[] bytes, int offset, bool value)
        {
            bytes[offset] = (byte)(value ? 1 : 0);
        }
               
        public static void BooleanTrueUnsafe(ref byte[] bytes, int offset)
        {
            bytes[offset] = (byte)(1);
        }

        public static void BooleanFalseUnsafe(ref byte[] bytes, int offset)
        {
            bytes[offset] = (byte)(0);
        }

        public static void Byte(ref byte[] bytes, int offset, byte value)
        {
            bytes[offset] = value;
        }

        public static int Bytes(ref byte[] bytes, int offset, byte[] value)
        {
            Buffer.BlockCopy(value, 0, bytes, offset, value.Length);
            return value.Length;
        }

        public static int SByte(ref byte[] bytes, int offset, sbyte value)
        {
            bytes[offset] = (byte)value;
            return 1;
        }

        public static unsafe int Single(ref byte[] bytes, int offset, float value)
        {
            if (offset % 4 == 0)
            {
        ...
        public static unsafe int Double(ref byte[] bytes, int offset, double value)
        {
            if (offset % 8 == 0)
            {
                fixed (byte* ptr = bytes)
        ...
        public static unsafe int Int16(ref byte[] bytes, int offset, short value)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe int Int32(ref byte[] bytes, int offset, int value)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe void Int32Unsafe(ref byte[] bytes, int offset, int value)
        {
            fixed (byte* ptr = bytes)
            {
                *(int*)(ptr + offset) = value;
        ...
        public static unsafe int Int64(ref byte[] bytes, int offset, long value)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe int UInt16(ref byte[] bytes, int offset, ushort value)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe int UInt32(ref byte[] bytes, int offset, uint value)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe int UInt64(ref byte[] bytes, int offset, ulong value)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static int Char(ref byte[] bytes, int offset, char value)
        {
            return UInt16(ref bytes, offset, (ushort)value);
        }

        public static int String(ref byte[] bytes, int offset, string value)
        {
            return StringEncoding.UTF8.GetBytes(value, 0, value.Length, bytes, offset);
        }

        public static unsafe int Decimal(ref byte[] bytes, int offset, decimal value)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe int Guid(ref byte[] bytes, int offset, Guid value)
        {
            fixed (byte* ptr = bytes)
            {
