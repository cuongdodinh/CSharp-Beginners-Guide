...
namespace C3SockNetUtil
{
    ...
    {  
        public static bool Boolean(ref byte[] bytes, int offset)
        {
        ...
        public static byte Byte(ref byte[] bytes, int offset)
        {
            return bytes[offset];
        }
        ...
        public static byte[] Bytes(ref byte[] bytes, int offset, int count)
        {
        ...
        public static sbyte SByte(ref byte[] bytes, int offset)
        {
        ...
        public static unsafe float Single(ref byte[] bytes, int offset)
        {
            if (offset % 4 == 0)
            {
        ...
        public static unsafe double Double(ref byte[] bytes, int offset)
        {
            if (offset % 8 == 0)
            {
                fixed (byte* ptr = bytes)
        ...
        public static unsafe short Int16(ref byte[] bytes, int offset)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe int Int32(ref byte[] bytes, int offset)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe long Int64(ref byte[] bytes, int offset)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe ushort UInt16(ref byte[] bytes, int offset)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe uint UInt32(ref byte[] bytes, int offset)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe ulong UInt64(ref byte[] bytes, int offset)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static string String(ref byte[] bytes, int offset, int count)
        {
            return StringEncoding.UTF8.GetString(bytes, offset, count);
        }
        
        public static unsafe decimal Decimal(ref byte[] bytes, int offset)
        {
            fixed (byte* ptr = bytes)
            {
        ...
        public static unsafe Guid Guid(ref byte[] bytes, int offset)
        {
            fixed (byte* ptr = bytes)
            {
